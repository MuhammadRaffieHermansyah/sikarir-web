        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <select name="id_mitra" id="id_mitra" required class="w-full px-3 py-2 text-xs border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-700">
            ...
            <div>
              ...
              <select name="id_admin" id="id_admin" required class="w-full px-3 py-2 text-xs border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-700">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" name="lokasi" id="lokasi" value="{{ old('lokasi', $lowongan->lokasi) }}" class="w-full px-3 py-2 text-xs border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-700" />
            </div>

            <div>
              <label for="tanggal_posting" class="block text-xs font-semibold text-slate-700 mb-1.5">Tanggal Posting</label>
              <input type="date" name="tanggal_posting" id="tanggal_posting" value="{{ old('tanggal_posting', $lowongan->tanggal_posting ? $lowongan->tanggal_posting->format('Y-m-d') : '') }}" class="w-full px-3 py-2 text-xs border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-700" />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea name="deskripsi" id="deskripsi" rows="4" class="w-full px-3 py-2 text-xs border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-700">{{ old('deskripsi', $lowongan->deskripsi) }}</textarea>
          </div>

          <div>
            <label for="kualifikasi" class="block text-xs font-semibold text-slate-700 mb-1.5">Kualifikasi & Persyaratan</label>
            <textarea name="kualifikasi" id="kualifikasi" rows="4" class="w-full px-3 py-2 text-xs border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-700">{{ old('kualifikasi', $lowongan->kualifikasi) }}</textarea>
          </div>
        </div>
      </div>
    </div>
